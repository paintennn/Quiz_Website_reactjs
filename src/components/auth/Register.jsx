                        ...
                        <div className="card-body">
                                ...
                                <div className="form-group mb-3 position-relative">
                                    <label htmlFor="password" className='mb-2'>
                                        ...
                                        >
                                            {showPassword ? <span><FaEyeSlash />Hide</span> : <span><FaEye />Show</span>}
                                        </span>
                                    </label>
                                    <input
                                ...
                                <button onClick={() => handleRegister()} type='submit' className="btn-submit btn btn-primary btn-block">Register</button>
                        </div>
                    </div>
                </div>
            </div>
